...
import {Compiler} from '@dustjs/data-tree/src/compiler.mjs';
import * as El from '@dustjs/data-tree/src/elements/_index.mjs'; // we give this to the schemas
...
export class SchemaLoader {
  ...
  async loadAllInDirectory(schemaDir) {
    ...
    for (const fileName of await readdir(realSchemaDir)) {
      ...
      const {metadata, builder} = require(fullPath);
      const roots = [];
